...
export const NUMERIC_LIMITS = {
  ...
  TIMEFRAME_MAX_DAYS: 1825, // 5 years
  ROI_TIMEFRAME_DEFAULT_DAYS: 365, // 1 year
  PRICE_MIN: 0,
  PRICE_MAX: 10000,
} as const;
...
export const INTERVALS = {
  ...
  ALERT_DELIVERY_BATCH_DELAY: 1000, // 1 second
  ANALYTICS_PROCESS_INTERVAL: 5 * 60 * 1000, // 5 minutes
  ANALYTICS_PROCESSING_DELAY: 1000, // 1 second
  METRICS_CLEANUP_INTERVAL: 24 * 60 * 60 * 1000, // 24 hours
  DISCORD_SIMULATION_DELAY: 500, // 500ms
  DISCORD_RATE_LIMIT_DELAY: 1000, // 1 second
  SITEMAP_CRAWL_DELAY: 1000, // 1 second
  WEBSOCKET_MESSAGE_DELAY: 1000, // 1 second
} as const;
...
export const HTTP_TIMEOUTS = {
  ...
  ALERT_DELIVERY: 15000, // 15 seconds
...
export const RETRY_CONFIG = {
  ...
  ANALYTICS_RETRY_DELAY: 5000, // 5 seconds
} as const;
